...
class FriepediaWebinarsEngine:
    ...
    def search(self, query, target_col=None, columns=None, top_k=6):
        """
        BACKEND API METHOD:
        Performs a semantic RAG search dynamically on ANY chosen column.
        """
        ...
        # If the client doesn't send a column, or sends a bad one, fallback safely.
        ...
        # 2. Vector Similarity against the Chosen Column
        ...
        # 3. Hybrid Logic (Keyword Bonus targeted at the Chosen Column)
        if self.nlp:
            doc = self.nlp(query)
        ...
        # 5. Smart Cleanup for Client Delivery
